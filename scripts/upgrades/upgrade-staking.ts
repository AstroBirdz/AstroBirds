...
const main = async() => {
  ...
  // staking
  let staking = new ethers.Contract("0x49ae07126cd7fdc1e4be57bdc9eee6065ecee5e6", AstroBirdzStakingAbi.abi, signer) as AstroBirdzStaking; // bsc test
  ...
  console.log(await staking.allConfiguredLocks())
